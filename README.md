...
`warden` is an agent skill built on [keel](https://github.com/G10DC/keel)'s trust
...
to a processing engine, or needs a replay-grade audit trail. See `SKILL.md` for the golden rules and a
